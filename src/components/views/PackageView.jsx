...
const PackageView = ({ title }) => (
    <Descriptions className='col-1' title={title} size="small" bordered>
        ...
        <Descriptions.Item  label= "מחיר" span={3}>
          <b>מחיר מוזל בהרשמה מוקדמת עד ה 15.03.23</b> <br /> 
            חדר זוגי בוילה או בבקתות העץ - 5150 ש"ח לאדם <br />
            חדר לשלישייה בדירת הסטודיו או בוילה - 4750 ש"ח לאדם <br />
             <b>מחיר לאחר ה 15.03.23</b> <br /> 
            חדר זוגי בוילה או בבקתות העץ - 5350 ש"ח לאדם <br />
            חדר לשלישייה בדירת הסטודיו או בוילה - 4950 ש"ח לאדם
        </Descriptions.Item>
